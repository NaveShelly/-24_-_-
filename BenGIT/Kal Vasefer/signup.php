...
<div style="margin: auto;width: 60%;position: absolute; left:250px; top:290px;">
	...
	<form id="fupForm" name="form1" method="post">
		<div class="form-group">
			<label for="email">תעודת זהות:</label>
			<input type="text" class="form-control" id="Child_ID" placeholder="הקלד כאן" name="name">
		</div>
		<div class="form-group">
			...
			$.ajax({
				...
				success: function(dataResult){
					...
					if(dataResult.statusCode==200){
						...
						window.location=("https://kalvasefer.000webhostapp.com/login.html");
					}
